...
\begin{figure}[tb]
\begin{center}
\subfloat{\includegraphics[width=0.40\textwidth]{figures/wave_eqn_1d_src_error_vs_N}}
...
the banded-diagonal biaplacian matrix in 1D leads to a relatively small hidden
...
constrast, errors introduced in matrix inversion affects both the 2nd- and
