%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solve4thOrderParabolicEqn1dForwardEulerOTS() computes the solutions of 
...
% check arguments
if (nargin < 3)
  error('solve4thOrderParabolicEqn1dForwardEulerOTS: missing arguments');
end
if (nargin < 4)
  debug_on = 0;
end
...
while (t < t_final)
  ...
  f_t = 10*pi^2 ...
      * ( -20*sin(2*pi*x)*cos(10*pi*t) ...
        - 32*pi^3*sin(2*pi*x)*sin(10*pi*t) ...
        + (-10*pi^2+625*pi^4)*sin(5*pi*x)*exp(-10*pi^2*t) );
