%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveDiffusionEqn1dForwardEulerOTSNoCorr() computes the solutions of the 
...
% solution is computed on a node-centered grid using forward Euler time 
% integration with a second-order central difference approximation to the 
% Laplacian.  The optimal time step of dx^2/(6D) is used but no correction
% term is used.
%
% USAGE:
%   function [u, u_exact, x, timing_data] = ...
%     solveDiffusionEqn1dForwardEulerOTSNoCorr(D, ...
%                                              source_term_type, ...
%                                              u_0, dudx_1, ...
%                                              dx, ...
%                                              t_init, t_final, ...
...
% check arguments
if (nargin < 7)
  error('solveDiffusionEqn1dForwardEulerOTSNoCorr: missing arguments');
end
if (nargin < 8)
  debug_on = 0;
end
