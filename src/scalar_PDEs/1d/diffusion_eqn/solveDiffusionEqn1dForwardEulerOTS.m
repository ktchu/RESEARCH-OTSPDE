%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveDiffusionEqn1dForwardEulerOTS() computes the solutions of the 1d 
% diffusion equation 
%
%   u_t = D u_xx + f(x)
%
...
% Laplacian.  The optimal time step of dx^2/(6D) and correction terms are 
% used.
%
% USAGE:
...
while (t < t_final)
  ...
  % update solution
  u = u + dt*D*(L*u) + dt*f + 0.5*D*dt^2*L*f;
