%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveDiffusionEqn1dDuFortFrankel() computes the solutions of the 1d 
% diffusion equation 
%
%   u_t = D u_xx + f(x)
%
...
% check arguments
if (nargin < 8)
  error('solveDiffusionEqn1dDuFortFrankel: missing arguments');
end
if (nargin < 9)
  debug_on = 0;
end
...
elseif (source_term_type == 1)
  ...
  error('solveDiffusionEqn1dDuFortFrankel: Invalid source term type.  Valid valuesare 0 and 1');
end

% take first time step using forward Euler time integration 
t = t_init;
