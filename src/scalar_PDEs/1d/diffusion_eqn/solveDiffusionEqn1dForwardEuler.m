%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveDiffusionEqn1dForwardEuler() computes the solutions of the 1d 
% diffusion equation 
%
%   u_t = D u_xx + f(x)
%
...
elseif (source_term_type == 1)
  ...
  error('solveDiffusionEqn1dForwardEuler: Invalid source term type.  Valid valuesare 0 and 1');
end
