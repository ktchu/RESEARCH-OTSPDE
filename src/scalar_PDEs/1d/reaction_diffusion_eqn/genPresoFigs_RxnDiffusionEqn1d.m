...
% reaction-diffusion equation for presentation purposes.
%  
% Kevin T. Chu
% 2009 April
% 
...
for i = 1:length(grid_sizes)
  ...
  if (use_saved_data == 1)
    ...
    [u_FE_OTS, u_exact, x, timing_data_FE_OTS] = ...
       solveRxnDiffusionEqnForwardEulerOTS1d(D, ...
                                          source_term_type, ...
                                          u_0, dudx_1, ...
                                          dx, ...
                                          t_init, t_final, ...
    ...
    [u_FE_OTS_no_corr, u_exact, x, timing_data_FE_OTS_no_corr] = ...
       solveRxnDiffusionEqnForwardEulerOTSNoCorr1d(D, ...
                                                source_term_type, ...
                                                u_0, dudx_1, ...
                                                dx, ...
                                                t_init, t_final, ...
    ...
    [u_FE, u_exact, x, timing_data_FE] = ...
       solveRxnDiffusionEqnForwardEuler1d(D, ...
                                       source_term_type, ...
                                       u_0, dudx_1, ...
                                       dx, dt_FE, ...
                                       t_init, t_final, ...
    ...
    [u_CN, u_exact, x, timing_data_CN] = ...
       solveRxnDiffusionEqnCrankNicholson1d(D, ...
                                         source_term_type, ...
                                         u_0, dudx_1, ...
                                         dx, dt_CN, ...
                                         t_init, t_final, ...
...
hold on;
plot(grid_sizes,err_FE_OTS_no_corr, 'g^', ...
     'MarkerSize',14, ...
     'MarkerFaceColor','g');
...
loglog(err_plot, ...
       ...
       'k');
hold on;
loglog(err_FE_OTS_no_corr(2:end), comp_time_FE_OTS_no_corr(2:end), 'g^', ...
       'MarkerSize',14, ...
       'MarkerFaceColor','g');
