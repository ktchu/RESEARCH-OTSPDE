%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveRxnDiffusionEqn1dNSFD() computes the solutions of the following 1d 
...
%     solveRxnDiffusionEqn1dNSFD(dx, dt, t_final, ...
%                                debug_on, timing_on)
%
% Arguments:
% - dx:                  grid spacing
...
% check arguments
if (nargin < 3)
  error('solveRxnDiffusionEqn1dNSFD: missing arguments');
end
if (nargin < 4)
  debug_on = 0;
end
...
% construct right-shift operator 
E = spdiags(e, -1, N, N);
