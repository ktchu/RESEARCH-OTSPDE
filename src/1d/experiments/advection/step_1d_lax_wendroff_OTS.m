...
%
% the Lax-Wendroff scheme with an optimal time step of dt = dx/a.  For 
% computational purposes, the domain is truncated to -1 < x < 1 and the 
% boundary conditions are taken to be u(-1) = 1 and u(1) = -1. 
% 
% Kevin T. Chu
% 2007 September
% 
