%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% solveRxnDiffusionEqn1dForwardEulerNoInterp() computes the solutions of 
...
% approximation for the Laplacians.  For both equations, the OTS correction 
% terms are added to the finite difference scheme.  The time step is taken
% to be the smaller of the optimal time steps for the two equations. 
%
% USAGE:
...
while (t < t_final)
  ...
  u = u + dt*u_t + 0.5*dt^2*u_corr;
  v = v + dt*v_t + 0.5*dt^2*v_corr;
