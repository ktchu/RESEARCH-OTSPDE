...
% solveAdvectionEqn1dForwardEuler() and solveAdvectionEqn1dForwardEulerOTS().
%  
% Kevin T. Chu
% 2008 July
% 
...
% solve advection equations using forward Euler with OTS
[u_FE_OTS, v_FE_OTS, u_exact, v_exact, x] = ...
  solveAdvectionEqn1dForwardEulerOTS(dx, ...
                                     t_init, t_final, ...
                                     debug_on);

% solve advection equations using forward Euler
