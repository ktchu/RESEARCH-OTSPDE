...
loglog(err_plot, ...
       ...
       'k');
hold on;
loglog(err_FE_OTS(3:end), comp_time_FE_OTS(3:end), 'go', ...
       'MarkerSize',14, ...
       'MarkerFaceColor','g');
...
loglog(err_plot, ...
       ...
       'k');
hold on;
loglog(err_FE(3:end), comp_time_FE(3:end), 'bs', ...
       'MarkerSize',14, ...
       'MarkerFaceColor','b');
...
loglog(err_plot, ...
       ...
       'k');
hold on;
loglog(err_CN(3:end), comp_time_CN(3:end), 'rd', ...
       'MarkerSize',14, ...
       'MarkerFaceColor','r');
